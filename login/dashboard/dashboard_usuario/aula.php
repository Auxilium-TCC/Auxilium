                    	...
                    	<div class='main-card mb-3 card' style="padding: 10px;">
	                    	<div class='app-page-title'>
	                            <div class='page-title-wrapper'>
									<h2 class="">Tema aula</h2>
								</div>
								<div class="row">
									<div class="col-lg-12 center embed"><div id="player"></div></div>
								</div>
								...
								<a href="(ARQUIVO)" download="NOME.TIPODEARQUIVO">Baixar Arquivos</a>	
							</div>
						</div>
